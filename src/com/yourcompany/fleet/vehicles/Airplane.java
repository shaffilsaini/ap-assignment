...
public class Airplane extends AirVehicle implements FuelConsumable, PassengerCarrier, CargoCarrier, Maintainable {
    ...
    public Airplane(String id, String model, double maxSpeed, double maxAltitude) throws InvalidOperationException { super(id, model, maxSpeed, maxAltitude); }
    ...
    public void move(double distance) throws InvalidOperationException {
        ...
        try {
            ...
            System.err.println("Failed to move Airplane " + getId() + ": " + e.getMessage());
        }
    }
    ...
    @Override
    public void performMaintenance() { this.maintenanceNeeded = false; System.out.println("Maintenance performed on Airplane " + getId() + "."); }
